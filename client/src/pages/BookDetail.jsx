...
import http from "../helpers/http"; // Pastikan helper HTTP diimport
...
export default function BookDetail() {
    ...
    // Panggil `fetchBooksById` dan `checkPaymentStatus` saat halaman dimuat
    useEffect(() => {
        if (id) {
    ...
    const handleAddToFavorite = async () => {
        if (!token) {
            Swal.fire({
                ...
                text: "Anda perlu login untuk menambahkan buku ke favorit.",
                icon: "error",
            });
            return;
        }
        ...
        <>
                ...
                <div className="w-full lg:w-2/3 lg:pl-5 mt-6 lg:mt-0 py-5">
                    ...
                    <div className="flex space-x-4 mt-4">
                        ...
                        <button
                            ...
                            className="btn btn-ghost text-black hover:bg-transparent hover:border-white hover:text-black"
                        >
                        ...
                        <div className="pr-30 text-gray-400">
                            {Number(bookDetail.price) === 0 || isPaid ? ( // Jika buku gratis atau sudah dibayar
                                ...
                                <button className="btn btn-dash btn-warning">🔒 Locked</button> // Tombol terkunci jika belum dibayar
                            )}
                        </div>
                    </div>
            ...
            <div className="bg-white px-50 -mt-55">
                ...
                <p className="text-gray-700 leading-relaxed">
                    ...
                    <b> "Bright orgasm. Anchoring techniques and NLP techniques."</b> The best guide for women. It will
                    help in the treatment of anorgasmia. You will master the techniques and methods of NLP and will be
                    able to apply them independently.
                </p>

                <p className="text-gray-700 leading-relaxed mt-3">
                    Thus, you will help yourself, dear women, to feel the fullness and beauty of orgasm. Enhance your
                    sexuality and attractiveness in the eyes of men. The book is written specifically for women. And it
                    will be a great gift for a couple looking for new pleasures.
                </p>
            </div>
        </>
    );
